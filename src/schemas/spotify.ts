...
export const PaginatedTracksSchema =
	PaginatedResponseSchema(SpotifyTrackSchema);
export const PaginatedPlaylistsSchema = PaginatedResponseSchema(
	SpotifyPlaylistSchema,
);
export const PaginatedAlbumsSchema =
	PaginatedResponseSchema(SpotifyAlbumSchema);
export const PaginatedArtistsSchema =
	PaginatedResponseSchema(SpotifyArtistSchema);
...
export const PaginatedSavedTracksSchema =
	PaginatedResponseSchema(SavedTrackSchema);
...
export const PaginatedPlaylistTracksSchema =
	PaginatedResponseSchema(PlaylistTrackSchema);
